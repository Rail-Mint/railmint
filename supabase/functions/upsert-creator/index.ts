...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    console.error(`[upsert-creator:${errorId}]`, e instanceof Error ? e.message : e);
    const msg = e instanceof Error && /signature|expired|wallet|handle|format/i.test(e.message)
      ? e.message
      : "Operation failed";
