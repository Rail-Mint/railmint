		...
		<div className="relative overflow-hidden">
			...
			<section className="container pb-12 pt-12 sm:pt-14 md:pb-20 md:pt-24">
				<motion.div
					...
					className="mx-auto max-w-5xl rounded-3xl border border-white/40 bg-gradient-to-br from-background via-background/95 to-amber-50/40 p-5 shadow-[0_24px_80px_-30px_rgba(15,23,42,0.55)] backdrop-blur-sm sm:p-6 md:p-10"
				>
					...
					<div className="grid items-center gap-10 md:grid-cols-[1.35fr_0.8fr]">
						<div>
							<h1 className="text-balance text-3xl font-semibold leading-[1.08] tracking-tight sm:text-4xl md:text-6xl">
