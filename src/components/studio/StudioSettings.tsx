		...
		<div className="space-y-6">
			...
			<Card className="border-border/40">
				...
				<CardContent className="space-y-3">
					...
					>
						<Switch defaultChecked aria-label="Toggle post generation alerts" />
					</SettingRow>
					<SettingRow
					...
					>
						<Switch
							defaultChecked
							aria-label="Toggle epoch rewards notifications"
						/>
					</SettingRow>
				</CardContent>
			</Card>
			...
			<Card className="border-border/40">
				...
				<CardContent className="space-y-3">
					...
					>
						<Switch defaultChecked aria-label="Toggle auto-generate posts" />
					</SettingRow>
				</CardContent>
			</Card>
			...
			>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							Your clone will stop generating new content and won't participate
							in future epochs. You can reactivate it at any time from Settings.
						</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
