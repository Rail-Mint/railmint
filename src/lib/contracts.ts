...
const CreatorRegistryABI = [
	...
	},
	{
		...
		inputs: [
			{ name: "creatorId", type: "uint256", indexed: true },
	...
	},
	{
		...
		inputs: [
			{ name: "creatorId", type: "uint256", indexed: true },
			{ name: "newProfileHash", type: "bytes32", indexed: false },
			{ name: "timestamp", type: "uint256", indexed: false },
		],
	},
	{
...
const RewardDistributorABI = [
	...
	},
	{
		...
		inputs: [
			{ name: "epochId", type: "uint256", indexed: true },
			{ name: "creatorIds", type: "uint256[]", indexed: false },
...
export const CREATOR_REGISTRY_ADDRESS =
	frontendEnv.VITE_CREATOR_REGISTRY_ADDRESS as `0x${string}` | undefined;
export const CONTENT_MANAGER_ADDRESS =
	frontendEnv.VITE_CONTENT_PUBLISHING_ADDRESS as `0x${string}` | undefined;
export const REWARD_DISTRIBUTOR_ADDRESS =
	frontendEnv.VITE_REWARD_DISTRIBUTOR_ADDRESS as `0x${string}` | undefined;
...
export function getContractMode(): "live" | "unavailable" {
	if (
